...
import tables as tb
from tables import IsDescription, UInt16Col, Float16Col, Float32Col, Float64Col, StringCol
...
class CreateAntennaTempeartureFile():
    def __init__(self, filename):
        ...
        self.pathforL1adata = L1a_DATA_PROCESSED_PATH
        self.thermistorName = [
            "OpBench MW-Horn",
            "OpBench MMW-MCMs",
    ...
    def InsertNavData(self, FirstSampleTime, GPSIMU) -> None:
    ...
    def InsertTempData(self, Thermistor) -> None:

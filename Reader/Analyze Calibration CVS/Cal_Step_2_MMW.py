...
cvsFileName='WCFC LN2 Calibration Points 2'
...
##################################################################### 
cvsFileName='2015_04_24_1113_44_WCFC LN2 Calibration Points 2_WCFC_LN2_Trec_model_MMW'
FromCVSFile=True
##################################################################### 
pathfordata=os.path.join(L0b_DATA_PROCESSED_PATH, 'WCFC LN2 Calibration Points 2CVS',  cvsFileName+'.csv')
...
for ChannelNameNumber in [0,1,2,3]:  
    ...
    if np.mod(ChannelNameNumber,4)==1:
        ...
        pathfordata='C:\IIP Software Project\AcqSystem\Reader\Results\L0bdata\WCFC LN2 Calibration Points 2CVS'

...
def calstep1(filepaths: list[Path]):
    ...
    fieldnames=['FileName', 'GPSTime', 'Radiometer Set', 'Channel', 'Cal. Coef.', 'Trec', 'Altitude', 'Lat.', 'Lon.', 'Ext Temp.', 'Rad. Temp.', 'std Rad. Temp.', 'TNS1', 'TNS2', 'TNS3','VNS1', 'VNS2', 'VNS3','Temp. MW-NS-18/24','Temp. MW-NS-34', 'VAMB', 'VLN2', 'Vref', 'stdVref', 'CalTarget Temp.', 'Horn Temp.', 'OpticalBench Temp.', 'Back Paraboloid Bottom Temp.', 'Back Paraboloid Middle Temp.', 'Back Paraboloid Top Temp.','CalTar|Upper Left[1]','CalTar|Lower Left[3]','CalTar|Center[2]','CalTar|Bottom Left[1]','CalTar|Bottom Right[3]','CalTar|Upper Right[3]' ,'CalTar|Lower Right[1]', 'CalTar|Top[2]']
    ...
    for CalIndex in range(0,len(filepaths)):
        ...
        for indexVector in range(0,1):
            ...
            for x in ChannelsToAnalyze: 
                ...
                if indexVector==0:
                    ...
                    elif NewDataFlag==True and ChannelSetToAnalyze=='mw' :
                        PhysicalReceiverTempChannels =ChSetdpa.Radiometer.PhysicalReceiverTempChannels[ChannelSetToAnalyze][0]
